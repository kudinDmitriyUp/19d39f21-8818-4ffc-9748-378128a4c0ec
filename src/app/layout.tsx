...
export const metadata: Metadata = {
  title: "Stellar Threads - Premium Clothing Collections",
  ...
  keywords: "clothing brand, fashion collection, premium apparel, sustainable fashion, style, contemporary clothing",
  metadataBase: new URL("https://stellar-threads.com"),
  alternates: {
    canonical: "https://stellar-threads.com"
  },
  openGraph: {
    title: "Stellar Threads - Premium Clothing Collections",
    description: "Elevate your wardrobe with our curated clothing collections featuring premium fabrics and timeless designs.",
    url: "https://stellar-threads.com",
    siteName: "Stellar Threads",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763757123533-s6v70kzf.jpg",
        alt: "Premium clothing collection showcase"
      }
    ]
  },
  twitter: {
    ...
    title: "Stellar Threads - Premium Clothing Collections",
    description: "Discover curated clothing collections designed for modern style and comfort.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763757123533-s6v70kzf.jpg"]
  },
  robots: {
    index: true,
    follow: true
